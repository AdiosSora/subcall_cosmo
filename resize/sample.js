(function() {
  ...
  kintone.events.on([
    ...
    kintone.app.record.setFieldShown('tempfile', false);
    kintone.app.record.getSpaceElement('space').innerHTML = '<div class="control-label-gaia"><span class="control-label-text-gaia">tempfile</span></div><div id="cropperWrapper"><input id="cropperFile" type="file"><div class="cropperContent"><div id="cropperPreview"></div><p><span id="cropperHeight"></span>*<span id="cropperWidth"></span>px</p></div><div class="cropperContent"><div id="cropperCanvas"></div></div></div>';
    ...
    if(event.type === 'app.record.edit.show'){
      ...
      xhr.open('GET', '/k/v1/file.json?fileKey=' + event.record.tempfile.value[0].fileKey);
